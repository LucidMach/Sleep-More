  ...
  <div className="stats-summary-container">
    <div style={{ flexGrow: 0.1 }}>
      <div
        ...
        style={{ marginBottom: "0.2rem", fontSize: "0.65rem" }}
      >
        SLEEP QUALITY
      </div>
      <div
    ...
    <div
      className="stats-summary-divider"
      style={{
        width: "1px",
      ...
      >
        <div
          style={{
            ...
            borderRadius: 2,
            background:
              "linear-gradient(to right, var(--danger) 0%, var(--warning) 45%, var(--accent-color) 50%, var(--accent-color) 66%, var(--warning) 72%, var(--danger) 100%)",
            position: "relative",
            marginBottom: "1rem",
          }}
        >
