...
const SleepInfo = () => (
  <div className="card" style={{ background: '#1e293b', border: '1px solid rgba(255,255,255,0.1)', padding: '2rem', color: 'var(--text-primary)' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', fontSize: '0.9rem', lineHeight: '1.6' }}>
      <p>
        Your sleep quality is calculated based on the ratio of <strong>REM</strong> and <strong>Deep</strong> sleep relative to your total time asleep.
      </p>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginTop: '0.5rem' }}>
        <div style={{ padding: '1rem', background: 'rgba(255,255,255,0.03)', borderRadius: '0.75rem' }}>
          <div style={{ fontWeight: 700, color: 'var(--deep)', marginBottom: '0.25rem' }}>DEEP SLEEP</div>
          <p style={{ fontSize: '0.8rem', opacity: 0.8 }}>Physical recovery, tissue growth, and immune system repair.</p>
        </div>
        <div style={{ padding: '1rem', background: 'rgba(255,255,255,0.03)', borderRadius: '0.75rem' }}>
          <div style={{ fontWeight: 700, color: 'var(--rem)', marginBottom: '0.25rem' }}>REM SLEEP</div>
          <p style={{ fontSize: '0.8rem', opacity: 0.8 }}>Cognitive recovery, memory consolidation, and emotional processing.</p>
        </div>
      </div>
      <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', fontStyle: 'italic', marginTop: '0.5rem' }}>
        * Aim for 6-8 hours of total sleep. Durations outside this range are marked as suboptimal (Orange/Red) on the heatmap.
      </p>
    </div>
  </div>
);
